...
org.apache.royale.events.DetailEvent.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    variables: function () {
      return {
        'detail': { type: 'String', get_set: function (/** org.apache.royale.events.DetailEvent */ inst, /** * */ v) {return v !== undefined ? inst.detail = v : inst.detail;}}
      };
    },
    methods: function () {
      return {
        'DetailEvent': { type: '', declaredBy: 'org.apache.royale.events.DetailEvent', parameters: function () { return [ 'String', false ,'Boolean', true ,'Boolean', true ,'String', true ]; }},
 ...
 * @type {number}
 */
org.apache.royale.events.DetailEvent.prototype.ROYALE_COMPILE_FLAGS = 10;

//# sourceMappingURL=./DetailEvent.js.map
