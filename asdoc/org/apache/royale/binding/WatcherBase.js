 ...
 * @return {boolean}
 */
org.apache.royale.binding.WatcherBase.prototype.valueChanged = function(oldval) {
...
org.apache.royale.binding.WatcherBase.prototype.wrapUpdate = function(wrappedFunction) {
  try {
    ...
    var /** @type {number} */ n = org.apache.royale.binding.WatcherBase.allowedErrorTypes.length;
    for (var /** @type {number} */ i = 0; i < n; i++) {
    ...
    n = org.apache.royale.binding.WatcherBase.allowedErrors.length;
    for (i = 0; i < n; i++) {
      if (s.indexOf(org.apache.royale.binding.WatcherBase.allowedErrors[i]) != -1)
        return;
    }
    throw error;
  }
  ...
  return {
    ...
    methods: function () {
      return {
        ...
        'parentChanged': { type: 'void', declaredBy: 'org.apache.royale.binding.WatcherBase', parameters: function () { return [  { index: 1, type: 'Object', optional: false } ]; }},
        'addChild': { type: 'void', declaredBy: 'org.apache.royale.binding.WatcherBase', parameters: function () { return [  { index: 1, type: 'org.apache.royale.binding.WatcherBase', optional: false } ]; }},
        'addBinding': { type: 'void', declaredBy: 'org.apache.royale.binding.WatcherBase', parameters: function () { return [  { index: 1, type: 'org.apache.royale.binding.GenericBinding', optional: false } ]; }},
